...
//			WSПроксиPing.Ping();
//		Исключение
//			ЗаписьЖурналаРегистрации(НСтр("ru = 'WSПрокси'","ru"),
...
//		ЗаписьЖурналаРегистрации(НСтр("ru = 'Получение версий интерфейса'","ru"),
...
//	Исключение
//		ЗаписьЖурналаРегистрации(НСтр("ru = 'Получение WSDL'","ru"),
//			УровеньЖурналаРегистрации.Ошибка, , , ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
//	КонецПопытки;
//	
//	Возврат Определения;
...
//	Возврат НСтр("ru='Поиск и удаление ссылок'","ru");
//КонецФункции
